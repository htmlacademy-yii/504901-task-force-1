...
<?php endif;?>
        ...
        <div class="main-container page-header__container page-header__container--index">
            ...
            <div class="header__account--index">
                <!-- <a id="user_enter" href="#" class="header__account-enter open-modal" data-for="loginId" data-toggle="modal" data-target="#login-modal"> -->
                <!-- <a href="#" data-toggle="modal" data-target="#login-modal">
                
                    <span>Вход</span></a> -->
                    <?= Html::a('Вход', ['/#', 'id' => 'user_enter'], ['data-bs-toggle' => 'modal', 'data-bs-target' => '#login-modal']) ?>
                или
                <a href="<?=Url::to(['/person/signup'])?>" class="header__account-registration">
                    Регистрация
                </a>
            </div>
        </div>
